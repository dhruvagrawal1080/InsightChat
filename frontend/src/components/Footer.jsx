        ...
        <footer id="footer" className="bg-gray-50 pt-12">
            ...
            <div className="mx-auto px-6 w-[85%] grid grid-cols-1 md:grid-cols-3 justify-items-center gap-8">
                ...
                <div>
                    <div className="flex items-end justify-center mb-4">
                        ...
                        <span className="ml-2 text-xl font-bold text-gray-800">InsightChat </span>
                    </div>
                    <p className="text-gray-600 text-center">Transform your team communication <br /> with AI-powered insights.</p>
                </div>
            ...
            <div className="py-6">
                <div className="border-t border-gray-200 mt-12 pt-8 text-center w-[80%] mx-auto">
                    © {new Date().getFullYear()} InsightChat. All rights reserved.
                </div>
            </div>
